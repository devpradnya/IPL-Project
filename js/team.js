...
function loadData(){
    filterData.map((item) => {
        ...
        if(item.from === "CSK"){
            ...
            playerCard.forEach((item) => item.addEventListener("click" , function(e){
       ...
       <img src="${item.teamImage}" alt="">
        <div class="team_Info_container" >
          <div class="team_box">
            ...
            <div class="team_info_logo"><p>Team Logo :</p> <img class="team_logo" src="${item.teamIcon}" alt=""></div>
            <p>Top Batsman : ${item.TopBatsman}</p>
            <p>Top Bowler : ${item.TopBowler}</p>
            <p>Trophies Count :  ${item.WonCount}</p>
      </div>
